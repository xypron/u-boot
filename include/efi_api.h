...
typedef struct efi_ipv4_address efi_ipv4_address_t;
...
typedef struct efi_mac_address efi_mac_address_t;
...
struct efi_ip4_route_table {
  efi_ipv4_address_t subnet_address;
  efi_ipv4_address_t subnet_mask;
  efi_ipv4_address_t gateway_address;
};
typedef struct efi_ip4_route_table efi_ip4_route_table_t;
...
struct efi_ip4_config2_interface_info {
  ...
  efi_mac_address_t hw_address;
  efi_ipv4_address_t station_address;
  efi_ipv4_address_t subnet_mask;
  uint32_t route_table_size;
  efi_ip4_route_table_t *route_table;
};

typedef struct efi_ip4_config2_interface_info efi_ip4_config2_interface_info_t;
...
struct efi_ip4_config2_manual_address{
  efi_ipv4_address_t address;
  efi_ipv4_address_t subnet_mask;
};

typedef struct efi_ip4_config2_manual_address efi_ip4_config2_manual_address_t;
...
struct efi_service_binding_protocol {
	efi_status_t (EFIAPI *create_child)(struct efi_service_binding_protocol *this, efi_handle_t *child_handle);
	efi_status_t (EFIAPI *destroy_child)(struct efi_service_binding_protocol *this, efi_handle_t child_handle);
};
...
struct efi_httpv4_access_point {
	...
	efi_ipv4_address_t local_address;
	efi_ipv4_address_t local_subnet;
	u16 local_port;
};
...
struct efi_http_protocol {
	efi_status_t (EFIAPI *get_mode_data)(struct efi_http_protocol *this, struct efi_http_config_data *data);
	efi_status_t (EFIAPI *configure)(struct efi_http_protocol *this, struct efi_http_config_data *data);
	efi_status_t (EFIAPI *request)(struct efi_http_protocol *this, struct efi_http_token *token);
	efi_status_t (EFIAPI *cancel)(struct efi_http_protocol *this, struct efi_http_token *token);
	efi_status_t (EFIAPI *response)(struct efi_http_protocol *this, struct efi_http_token *token);
